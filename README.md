# ERC20_API
ERC20-api-波场接口源码-PHP版本-ThinkPHP5版本  ，可无缝升级TP6。
...
# 目前已经基于这套API开发出来了靓号采集系统以及资金归集系统，相关详情看当前项目的doc文件 ：[相关代码详细说明](   https://github.com/chaineex/ERC20_API/u)

## 联系
- Telegram: https://t.me/huoex
- Email: chainmex@hotmail.com

接口文档地址：[https://www.showdoc.com.cn/2008380509132949/9086375496948880](https://www.showdoc.com.cn/2008380509132949/9086375496948880)
...
------------
# ERC20-api-波场接口源码-PHP版本-ThinkPHP5版本
## 接口文档编辑时间为 2022年7月1日09:35:40
### 有问题可以找我Telegram: https://t.me/huoex
### 源码会一直更新，当前版本的接口完整源码需要收费，包协助部署（源码无加密）
...
##### 请求URL
- ` http://xx.com/api/ERC20/generateAddress`
...
##### 请求URL
- ` http://xx.com/api/ERC20/getAddressBalance?address=TGDsEr2cSRC98Zo9WnwNDik2Y5rdboPRvd `
...
##### 请求URL
- ` http://xx.com/api/ERC20/transData?txID=40ad467bc5d727164988312e992ea3d7402743d82c4b26244f92ba4194302ce2 `
...
##### 请求URL
- ` http://xx.com/api/ERC20/getAddress?privateKey=41369219ae69fc11ecb589cdd5fdd9a0248918402bdf4d6fe0a7fb6ca752b38b `
...
##### 请求URL
- ` http://xx.com/api/ERC20/blockNumber `
...
##### 请求URL
- ` http://xx.com/api/ERC20/blockByNumber?blockID=40743210`
...
##### 请求URL
- ` http://xx.com/api/ERC20/transfer?key=41369219ae69fc11ecb589cdd5fdd9a0248918402bdf4d6fe0a7fb6ca752b38b&toaddress=TYPrKF2sevXuE86Xo3Y2mhFnjseiUcybny&amount=10`
...
##### 请求URL
- ` https://api.ERC20grid.io/v1/accounts/TYPrKF2sevXuE86Xo3Y2mhFnjseiUcybny/transactions/ERC20?limit=100&contract_address=TR7NHqjeKQxGTCi8q8ZY4pL8otSzgjLj6t`
...
##### 请求URL
- ` https://apiasia.ERC20scan.io:5566/api/transaction?sort=-timestamp&count=true&limit=20&start=0&address=TYPrKF2sevXuE86Xo3Y2mhFnjseiUcybny `
    ...
    "data": [
   {
    ...
    "contractInfo": {
        ...
        "TR7NHqjeKQxGTCi8q8ZY4pL8otSzgjLj6t": {
            ...
            "tag1Url": "https://ERC20.network/usdt",
...
{
    "code": 0,
    "msg": "class org.ERC20.core.exception.ContractValidateException : Validate TransferContract error, no OwnerAccount.",
    "data": null,
    "time": 1652930705
}
...
{
    "code": 0,
    "msg": "class org.ERC20.core.exception.ContractValidateException : No owner account!",
    "data": null,
    "time": 1652932448
}
